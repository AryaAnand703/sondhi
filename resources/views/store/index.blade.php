...
<body class="font-sans antialiased">
    ...
    <div id="welcome-overlay" style="display: none;"
        class="fixed inset-0 z-[100] items-center justify-center bg-black/70 px-6 backdrop-blur-sm transition-all duration-700 ease-out select-none"
    ...
    <script>
        (function () {
            try {
                ...
                if (params.get('welcome') === '1' || params.get('reset_welcome') === '1') {
                    localStorage.removeItem('sondhi_welcome_seen');
                }
                var seen = localStorage.getItem('sondhi_welcome_seen');
                if (!seen) {
